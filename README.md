...
## Installation Guide
The provided scripts for the configuration and installation of Kibana, Elasticsearch, and Wazuh include step-by-step instructions in this `README.md` file on making the scripts executable and how to run them. This ensures a smooth setup process.
